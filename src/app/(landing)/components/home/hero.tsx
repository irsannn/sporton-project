        ...
        <section id="hero-section" className="container mx-auto h-screen flex">
            <div className="relative self-center flex">
                ...
                <div className="relative ml-40 w-full">
                    ...
                    <h1 className="font-extrabold text-[95px]  bg-gradient-to-b leading-tight from-black to-[#979797D1] bg-clip-text text-transparent">
                        WEAR YOUR <br />
                        TOP-QUALITY <br /> SPORTSWEAR
                    </h1>
                ...
                width={700} 
                height={950} 
                alt="image sporton hero" className="absolute -right-5 top-1/2 -translate-y-1/2" 
                />
